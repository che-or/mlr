...
def apply_postprocessing_corrections(player_stats_df):
    ...
    s1_p237_mask = (
        (player_stats_df["Season"] == "S1")
        & (player_stats_df["Pitcher ID"] == 237)
        & (player_stats_df["Team"] == "BAL")
    )
    ...
    s2_p373_mask = (
        (player_stats_df["Season"] == "S2")
        & (player_stats_df["Pitcher ID"] == 373)
        & (player_stats_df["Team"] == "BAL")
    )
    ...
    s3_p321_mask = (
        (player_stats_df["Season"] == "S3")
        & (player_stats_df["Pitcher ID"] == 321)
        & (player_stats_df["Team"] == "ARI")
    )
    ...
    s3_p269_mask = (
        (player_stats_df["Season"] == "S3")
        & (player_stats_df["Pitcher ID"] == 269)
        & (player_stats_df["Team"] == "OAK")
    )
